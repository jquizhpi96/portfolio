    ...
    <div className="container">
      <div className="projects" >
        <div className="project">
            ...
            <button className="deploy"><a className="link" target="_blank"href="https://jquizhpi96.github.io/Gotta-Catch-Them-All/">See the app</a></button>
            <button className="github"><a className="link" target="_blank"href="https://github.com/jquizhpi96/Gotta-Catch-Them-All">See the code</a></button>
                    </div>
</p>
        </div>
        <div className="project">
            ...
            <div className="button-container">
            <button className="deploy"><a className="link"target="_blank" href="https://cregs-list.netlify.app/">See the app</a></button>
            <button className="github"><a className="link"target="_blank" href="https://github.com/jquizhpi96/Cregs-List">See the code</a></button>
                    </div>
</p>
        </div>
        <div className="project">
          ...
          <div className="button-container">
          <button className="deploy"><a className="link"target="_blank" href="https://the-dog-spot.netlify.app/">See the app</a></button>

          <button className="github"><a className="link"target="_blank" href="https://github.com/amarp86/The-Dog-Spot">See the code</a></button>
                    </div>
          </div>
          <div className="project">
          ...
          <div className="button-container">
                        <button className="deploy"><a className="link" target="_blank"href="https://yak-yik.netlify.app/">See the app</a></button>
                        <button className="github"><a className="link" target="_blank"href="https://github.com/jquizhpi96/Yak-Yik">See the code</a></button>
                    </div>
</p>
        </div>
      </div>
