    ...
    <div className="container">
      <div className="projects" >
        ...
        <div className="project">
          ...
          <p className="brief">The Dog Spot is a full CRUD application utilizing MERN stack that is focused towards pet adoption centers nationwide to use as a forward facing inventory application. This application has user authorization and authentication implemented to store adoption status of listed animals across users.</p>
        </div>
          <div className="project">
